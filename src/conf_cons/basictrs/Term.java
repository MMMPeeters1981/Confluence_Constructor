...
public class Term {
	...
	public boolean contractAttempt = false;
	// a term contains (if already contracted) a set of possible contractions
	public Set<Reductionstep> possibleContractions = new HashSet<Reductionstep>();
	 ...
	 */
	public Term (Function f, Term[] st) {
		function = f;
